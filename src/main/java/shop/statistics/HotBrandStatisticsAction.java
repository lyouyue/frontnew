...
public class HotBrandStatisticsAction extends BaseAction {
	/**订单Service*/
	 ...
	 */
	public String gotoHotBrandStatistics(){
		return SUCCESS;
	}
	/**
	 * @功能： 热门品牌销售统计列表查询
	 ...
	 */
	public void listHotBrandStatistics() throws IOException{
		String sql=" select t.brandId,t.brandName,t.brandImageUrl as brandImageUrl,count(o.ordersId) as count from shop_productinfo p,shop_orderslist os,shop_orders o,shop_brand t where os.ordersId=o.ordersId and p.productId=os.productId and p.brandId=t.brandId ";
		String createTime = request.getParameter("createTime");
		String createTime2 = request.getParameter("createTime2");
		String brandName = request.getParameter("brandName");
		if(brandName!=null&&!"".equals(brandName)){
			sql+=" and t.brandName like '%"+brandName.trim()+"%'";
		}
		...
		String sqlCount="select count(b.brandId) as count from ("+sql+") b";
	...
	public List<List<String>> ordersColumnValuesList(List<Map<String,Object>> list)
		...
		for (Map cc : list) {
			...
			columnValuesList.add(String.valueOf(cc.get("brandName")));
