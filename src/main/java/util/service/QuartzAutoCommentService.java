...
public class QuartzAutoCommentService implements ServletContextAware {
    ...
    public void saveAutoComment(){
        //获取配置文件内设定的扫描时间间隔
        Integer quartz_autoComment = Integer.parseInt(String.valueOf(ConfigUtils.getSystemConfigValue(ServletActionContext.getServletContext(),"quartz_autoComment")));
    ...
    public void saveAutoTakeDelivery(){
        //获取配置文件内设定的扫描时间间隔
        Integer quartz_takeDelivery = Integer.parseInt(String.valueOf(ConfigUtils.getSystemConfigValue(ServletActionContext.getServletContext(),"quartz_takeDelivery")));
		/*SimpleDateFormat sdf=new SimpleDateFormat("yyy-MM-dd HH:mm:ss");
