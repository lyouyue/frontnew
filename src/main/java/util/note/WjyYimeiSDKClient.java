...
//		System.out.println("*********");
		try {
			...
			Client client = SingletonClient.getClient();
			int i=client.sendSMS(new String[] {phone},"您正在登录商城微商城，验证码："+message+" ，为了您的账户安全，请勿将验证码告知他人。【商城微商城】",5);//带扩展码
//			System.out.println("手机号码:"+phone);
//			System.out.println("短信内容:"+"您正在登录商城微商城，验证码："+message+"，为了您的账户安全，请勿将验证码告知他人。【商城微商城】");
