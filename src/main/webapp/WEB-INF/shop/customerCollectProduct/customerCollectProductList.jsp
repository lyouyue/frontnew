  ...
  <head>
    ...
    $(function(){
		   $("#tt").datagrid({//数据表格
				...
				url:"${pageContext.request.contextPath}/back/customerCollectProduct/listCustomerCollectProduct.action?customerId=${customerId}",
				queryParams:{pageSize:pageSize},                                                                                               
				idField:"customerCollectProductId",//唯一性标示字段
				frozenColumns:[[//冻结字段
				    {field:"ck",checkbox:true}
				]],
				columns:[[//未冻结字段
					{field:"logoImg",title:"套餐图片",width:100, formatter:function(value,rowData,rowIndex){  //function里面的三个参数代表当前字段值，当前行数据对象，行号（行号从0开始）
					...
					{field:"productName",title:"套餐名称",width:80},
					{field:"shopName",title:"店铺名称",width:80},
					{field:"salesPrice",title:"套餐销售价",width:80},
				]],
