  ...
  <head>
    ...
    $(function(){
		   $("#tt").datagrid({//数据表格
				...
				queryParams:{pageSize:pageSize, orderState:'6,7'},
				...
				columns:[[//未冻结字段
					...
					{field:"consignee",title:"体检人名称",width:120},
...
<%--					{field:"address",title:"收货地址",width:200},--%>
					...
					{field:"updateTime",title:"订单取消时间",width:120, formatter:function(value,rowData,rowIndex){  //function里面的三个参数代表当前字段值，当前行数据对象，行号（行号从0开始）
						return toJsonDate(value,"yyyy-MM-dd hh:mm:ss");
					}}
				]],
