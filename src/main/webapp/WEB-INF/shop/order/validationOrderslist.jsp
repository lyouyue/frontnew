  ...
  <head>
    ...
    $(function(){
		   $("#tt").datagrid({//数据表格
				...
				url:"${pageContext.request.contextPath}/back/orders/ordersList.action?orderState=5",
...
<%--					{field:"address",title:"收货地址",width:200},--%>
    	...
    	function query(){
		  queryParams={selectFlag:true,pageSize:pageSize,currentPage:currentPage,ordersNo:$("#qordersNo").val(),shopInfoType:$("#qshopInfoType").val()};
