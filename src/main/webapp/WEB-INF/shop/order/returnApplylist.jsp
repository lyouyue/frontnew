  ...
  <head>
    ...
    $(function(){
		   $("#tt").datagrid({//数据表格
				...
				url:"${pageContext.request.contextPath}/back/orders/returnsApplyList.action",
				...
				columns:[[//未冻结字段
					...
					{field:"createTime",title:'订单生成时间',width:200, formatter:function(value,rowData,rowIndex){  //function里面的三个参数代表当前字段值，当前行数据对象，行号（行号从0开始）
		...
		<div class="main">
			<table class="searchTab">
				<tr>
					...
					<td class="search_toleft_td" style="width:170px;"><input type="text" id="ordersNo" name="s_name"  style="width:160px;" class="searchTabinput"/></td>
