...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	$(function(){
			...
			var defHtml="";
			$("#tt").datagrid({//数据表格
				/* title:"套餐规格列表信息:<font color='blue'>${name}</font>",
				iconCls:"icon-save",  */
				width:"auto",
				height:"auto",
				...
				%>         
			      {//工具条
					...
					iconCls:"icon-add",
					handler:function(){
						createWindow(900,450,"&nbsp;&nbsp;添加套餐规格","icon-add",false,"addOrEditWin",10);
				...
				%>
				{
					...
					handler:function(){
						...
						if(rows.length<=0){
							...
							createWindow(900,450,"&nbsp;&nbsp;修改套餐规格","icon-edit",false,"addOrEditWin",10);
