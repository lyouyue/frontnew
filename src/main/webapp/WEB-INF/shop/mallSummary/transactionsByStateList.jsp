	...
	<script type="text/javascript">
		$(function(){
			$("#tt").datagrid({//数据表格
				...
				url:"${pageContext.request.contextPath}/back/transactionsByState/ListTransactionsByState.action",
				...
				columns:[[//未冻结字段
					...
					{field:"beginTime",title:"起始日期",width:110},
					{field:"endTime",title:"截止日期",width:110},
				]],
				toolbar:[//工具条
				    <%
					...
					handler:function(){
						...
						if(rowNum.length>0){
							$.ajax({
								type: "POST",
								dataType: "JSON",
								url : "${pageContext.request.contextPath}/back/transactionsByState/importExcelJYHZBS.action",
	...
	<div class="main">
		...
		<table  class="searchTab">
			<tr>
					...
					<td class="toright_td" style="width:70px;"> 统计日期：</td>
					<td class="toleft_td"  style="width:255px;">
					...
					<td class="toright_td" style="width:65px;">订单状态 ：</td>
					<td class="toleft_td" style="width:125px;">
					...
					<td class="toright_td" style="width:60px;;">店铺类型：</td>
