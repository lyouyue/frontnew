...
<script type="text/javascript">
	...
	function showDetailInfo(id){
		createWindow(1000,480,"&nbsp;&nbsp;自营店铺详情","icon-tip",false,"detailWin",10);
		...
		$.ajax({
			   ...
			   success: function(data){
				   ...
				   $("#dlogoUrl").html("<img src='"+"${fileUrlConfig.uploadFileVisitRoot}"+shop.logoUrl+"' onerror='this.src=\"${fileUrlConfig.sysFileVisitRoot_back}productInfo/images/mrbj.png\"' width='40px' height='40px' />");
				   $("#dqrCode").html("<img src='"+"${fileUrlConfig.uploadFileVisitRoot}"+shop.qrCode+"' onerror='this.src=\"${fileUrlConfig.sysFileVisitRoot_back}productInfo/images/mrbj.png\"' width='40px' height='40px' />");
				   $("#dbannerUrl").html("<img src='"+"${fileUrlConfig.uploadFileVisitRoot}"+shop.bannerUrl+"' onerror='this.src=\"${fileUrlConfig.sysFileVisitRoot_back}productInfo/images/mrbj.png\"' width='40px' height='40px' />");
				   ...
				   $("#dbusinessLicense").html("<img src='"+"${fileUrlConfig.uploadFileVisitRoot}"+shop.businessLicense+"' onerror='this.src=\"${fileUrlConfig.sysFileVisitRoot_back}productInfo/images/mrbj.png\"' width='40px' height='40px' />");
				   $("#dcompanyDocuments").html("<img src='"+"${fileUrlConfig.uploadFileVisitRoot}"+shop.companyDocuments+"' onerror='this.src=\"${fileUrlConfig.sysFileVisitRoot_back}productInfo/images/mrbj.png\"' width='40px' height='40px' />");
				   var num = shop.isPass;
				   if(num == 3){
...
<div id="detailWin">
    <table align="center" class="addOrEditTable" width="850px;">
			...
			<tr>
				<td class="toright_td" width="140px">执照图片预览 :</td>
				<td  class="toleft_td" colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="dbusinessLicense" ></span></td>
				<td class="toright_td" width="140px">身份证照图片预览 :</td>
				<td  class="toleft_td"  style="width:310px;" colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="dcompanyDocuments" ></span></td>
			</tr>
			<tr>
				<td class="toright_td" width="140px">店铺账号:</td>
				...
				<td class="toright_td" width="140px">公司名称:</td>
			 ...
			 <tr>
				...
				<td class="toright_td" width="140px">邮政编码:</td>
			...
			<tr>
				<td class="toright_td" width="140px">店铺Logo :</td>
				<td  class="toleft_td" colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="dlogoUrl"></span></td>
				<td class="toright_td" width="140px">店铺首页大图:</td>
				<td  class="toleft_td" colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="dbannerUrl" ></span></td>
			</tr>
			<tr >
				<td class="toright_td" width="140px">店铺分类:</td>
				...
				<td class="toright_td" width="140px">店铺名称:</td>
			...
			<tr>
				<td class="toright_td" width="140px">联系电话:</td>
				<td class="toleft_td" colspan="3">&nbsp;&nbsp;<span id="dphone"></span></td>
				<td class="toright_td" width="140px">主要销售产品:</td>
			...
			<tr>
				...
				<td class="toright_td" width="140px">订单是否包邮:</td>
			...
			<tr>
				...
				<td  class="toleft_td" colspan="3">&nbsp;&nbsp;<span id="isPas" ></span></td>
			...
			<%-- <tr>
		      ...
		      <td  class="toleft_td" colspan="3">&nbsp;&nbsp;
		          &nbsp;&nbsp;&nbsp;&nbsp;<span id="dlogoUrl"></span>
		      </td>
		      <td class="toright_td" width="150px">店铺首页大图:</td>
		      <td  class="toleft_td" colspan="3">&nbsp;&nbsp;
		          &nbsp;&nbsp;&nbsp;&nbsp;<span id="dbannerUrl" ></span>
		      </td>
			</tr> --%>
    </table>
