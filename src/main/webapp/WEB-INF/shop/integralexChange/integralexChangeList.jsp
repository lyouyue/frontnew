  ...
  <head>
    ...
    $(function(){
		   $("#tt").datagrid({//数据表格
				...
				columns:[[//未冻结字段
		            {field:"productId",title:"套餐名称",width:120, formatter:function(value,rowData,rowIndex){  //function里面的三个参数代表当前字段值，当前行数据对象，行号（行号从0开始）
					...
					{field:"maxProducts",title:"可兑换套餐数量",width:120},
