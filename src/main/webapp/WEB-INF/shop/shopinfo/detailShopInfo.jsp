...
<script type="text/javascript">
	...
	function showDetailInfo(id){
		createWindow(900,480,"&nbsp;&nbsp;机构详情","icon-tip",false,"detailWin",10);
...
<div id="detailWin">
    <table align="center" class="addOrEditTable" width="850px;">
			...
			<tr>
				<td class="toright_td" width="150px">机构账号:</td>
			...
			<tr><td colspan='8' align='center' class="titlebg">机构信息</td></tr>
			<tr>
				<td class="toright_td" width="150px">机构Logo :</td>
				<td  class="toleft_td" colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="dlogoUrl"></span></td>
				<td class="toright_td" width="150px">机构首页大图:</td>
				<td  class="toleft_td" colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="dbannerUrl" ></span></td>
			</tr>
			<tr >
				<td class="toright_td">机构二维码</td>
				<td class="toleft_td" colspan="3">&nbsp;&nbsp;<span id="dqrCode"></span></td>
				<td class="toright_td" width="150px">机构名称:</td>
			...
			<tr>
				<td class="toright_td" width="150px">机构分类:</td>
