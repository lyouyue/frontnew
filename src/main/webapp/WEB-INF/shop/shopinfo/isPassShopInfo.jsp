...
<script type="text/javascript">
	...
	function tj(){
		...
		$.post(url,{ids:$("#pshopInfoId").val(),saveIsPass:$("#saveIsPass").val(),savePhoneShowStatus:$("#savePhoneShowStatus").val(),saveShopInfoCheckSatus:$("#psaveShopInfoCheckSatus").val(),commission:$.trim($("#pcommission").val())},function(data){
			if(data.isSuccess){
				closeWin();
				$("#tt").datagrid("reload");
			}
...
<div id="passWin">
	    ...
	    <table align="center" class="addOrEditTable" width="850px;">
	    	...
	    	<tr>
				<td class="toright_td" width="150px">营业执照（三证合一）预览:</td>
	    	...
	    	<tr>
		      ...
		      <td class="toleft_td" colspan="3">&nbsp;&nbsp;<input style="border: 0" id="dpcompanyName" type="text" size="30" name="shopInfo.companyName" readonly="readonly" /></td>
		    </tr>
		    <tr>
