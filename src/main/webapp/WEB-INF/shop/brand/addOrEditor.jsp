		...
		$("#form1").validate({meta: "validate", 
			...
			$(document).ready(
				function() {  
					...
					$("#mymessage2").html("<font color='Red'>请上传机构列表大图！</font>");
					if(imageUrl1!=null && imageUrl1!=''){}else{
						$("#mymessage1").html("<font color='Red'>请上传首页推荐机构图片！</font>");
					}
				}
			}else{
				$("#mymessage1").html("<font color='Red'>请上传首页推荐机构图片！</font>");
...
<div id="addOrEditWin">
	<form id="photoForm1" method="post" enctype="multipart/form-data">
     <table align="center" class="addOrEditTable" width="600px;">
          <tr>
		      <td class="toright_td" width="116px"><span style="color:red">* </span>首页推荐机构:&nbsp;&nbsp; </td>
		      ...
		      <td class="toright_td" width="100px"><span style="color:red">* </span>首页推荐机构:&nbsp;&nbsp;</td>
	...
	<form id="photoForm2" method="post" enctype="multipart/form-data">
     <table align="center" class="addOrEditTable" width="600px;">
          <tr>
		      <td class="toright_td" width="116px"><span style="color:red">* </span>机构列表大图:&nbsp;&nbsp; </td>
		      <td class="toleft_td" width="440px">
		      ...
		      <td class="toright_td" width="100px">机构列表大图:&nbsp;&nbsp;</td>
    ...
    <form id="form1"  method="post">
	    ...
	    <table align="center" class="addOrEditTable" width="600px;">
		    <tr>
		      <td class="toright_td" width="195px"><span style="color:red">* </span>机构名称:&nbsp;&nbsp;</td>
		    ...
		    <tr>
		      <td class="toright_td" width="195px">机构归类:&nbsp;&nbsp;</td>
		    ...
		    <tr>
		      <td class="toright_td" width="195px">机构频道推荐:&nbsp;&nbsp;</td>
		      ...
		      <td class="toright_td" width="195px">机构首页机构推荐:&nbsp;&nbsp;</td>
