	  ...
	  <head>
		...
		$(function(){
			$("#tt").datagrid({//数据表格
				...
				columns:[[//未冻结字段
					{field:"shopsCode",title:"机构编号",width:150, formatter:function(value,rowData,rowIndex){  //function里面的三个参数代表当前字段值，当前行数据对象，行号（行号从0开始）
						return "<a style='display:block;cursor: pointer;' id='"+rowData.shopsId+"' onclick='showDetailInfo(this.id);'>"+rowData.shopsCode+"</a>";  
					}
					}, 
					{field:"shopsName",title:"机构名称",width:150},
				...
				toolbar:[
					...
					{//工具条
						...
						handler:function(){
							...
							createWindow(850,'auto',"&nbsp;&nbsp;添加线下机构","icon-add",false,"addOrEditWin");
						}
					},"-",
					<%
					//}
					...
					%>
					{
						...
						handler:function(){
							...
							if(rows.length==0){//没有选择修改项
								...
								createWindow(850,'auto',"&nbsp;&nbsp;修改线下机构","icon-edit",false,"addOrEditWin");
								   $.ajax({
	...
	<body>
		...
		<table class="searchTab">
			<tr>
				<td class="search_toright_td" style=" width:80px; ">机构编号：</td>
