...
<div id="addOrEditWin">
	<form id="form1"  method="post" >
		...
		<table align="center" class="addOrEditTable" >
			<tr>
			  <td class="toright_td" width="150px">套餐参数名称:</td>
			...
			<tr>
				...
				<input id="productParametersInfo" type="hidden" name="productParameters.info" value=""/> <!-- 用来存储套餐详细参数内容 //-->
			  <td class="toright_td" width="150px">套餐参数值:</td>
