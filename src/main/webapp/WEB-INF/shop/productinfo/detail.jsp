...
<div id="detailWin">
	<table id="detailTable" align="center" class="addOrEditTable">
		...
		<tr>
			<td class="toright_td" width="150px">套餐编号:</td>
		...
		<tr>
			<td class="toright_td" width="150px">套餐所属分类:</td>
		...
		<tr>
			<td class="toright_td" width="150px">套餐品牌:</td>
		...
		<tr>
			<td class="toright_td" width="150px">套餐图片:</td>
		...
		<tr>
			<td class="toright_td" width="150px">套餐备注:</td>
