...
<%--		        	validateData();--%>
     ...
     function getProductTypeInfoList(){
		 ...
		 $.ajax({//获取MES牌号信息
			   ...
			   dataType: "JSON",
			   success: function(data){
				   var htmlStr="<tr style='background-color: #C4E1FF;font-weight: bolder;'><td width='8px' class='toleft_td'><input type='checkbox' onclick='checkedAll(this)'></td><td width='250px' class='toleft_td'>&nbsp;&nbsp;套餐分类名称</td></tr>";
...
<%--				<input type="hidden" name="disproduct.promotionId" value="${promotionId}">--%>
				<table align="center" class="addOrEditTable">
					<tr>
						<td class="toright_td"width="100px;">套餐分类信息：</td>
