  ...
  <head>
    ...
    $(function(){
    	$("#tt").datagrid({//数据表格
			...
			columns:[[//未冻结字段
	            {field:"productFullName",title:"套餐名称",width:180},
	            {field:"salesCount",title:"已付款套餐数量",width:80},
	            {field:"salesPrice",title:"已付款套餐金额",width:80},
	            {field:"refundCount",title:"已退货套餐数量",width:80},
	            {field:"refundPrice",title:"已退货套餐金额",width:80}
			]],
...
<jsp:include page="../../util/item.jsp"/>
	...
	<div class="main">
		...
		<table   class="searchTab">
			<tr>
				<td class="toright_td" style="width: 85px;">套餐名称：</td>
