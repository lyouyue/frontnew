...
<script type="text/javascript">
	function showDetailInfo(id){
		createWindow(900,470,"&nbsp;&nbsp;首页轮播图详情","icon-tip",false,"detailWin",20);
		...
		$.ajax({
			   ...
			   success: function(data){
				   $("#dbroadcastingIamgeUrl").html("<img style='padding-top:10px'  src='"+"<s:property value='%{#application.fileUrlConfig.uploadFileVisitRoot}'/>"+data.broadcastingIamgeUrl+"' onerror='this.src=\"${fileUrlConfig.sysFileVisitRoot_back}productInfo/images/mrbj.png\"' width='200px' height='100px' />");
...
<div id="detailWin">
    <table align="center" class="addOrEditTable" width="800px;">
    	<tr>
		    <td class="toright_td" width="150px">图片:</td><td  class="toleft_td" colspan="3">&nbsp;&nbsp;<span id="dbroadcastingIamgeUrl"></span></td>
	    </tr>
	   <%--   <tr>
	    ...
	    <tr>
	    	<td class="toright_td">主题:</td><td class="toleft_td" colspan="3">&nbsp;&nbsp;<span id="dtitle"></span></td>
	    </tr>
	    <tr>
   	      <td class="toright_td" width="150px">简介:</td><td  class="toleft_td"  colspan="3">&nbsp;&nbsp;<span id="dsynopsis"></span></td>
		</tr>
	    <tr>
		    <td class="toright_td" width="150px">链接:</td><td  class="toleft_td">&nbsp;&nbsp;<span id="dinterlinkage"></span></td>
