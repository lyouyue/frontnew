  ...
  <head>
    ...
    $(function(){
		   ...
		   $("#tt").datagrid({//数据表格
				...
				columns:[[//未冻结字段
		            {field:"name",title:"套餐ID",width:120, formatter:function(value,rowData,rowIndex){  //function里面的三个参数代表当前字段值，当前行数据对象，行号（行号从0开始）
				...
				toolbar:[{//工具条
					...
					iconCls:"icon-add",
					handler:function(){
						createWindow(800,500,"&nbsp;&nbsp;添加套餐","icon-add",false,"win");
						$("#form1").css("display","");
