...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
		   ...
		   $("#tt").datagrid({//数据表格
				...
				{//工具条
					...
					handler:function(){
						...
						$("#mymessage1").html("");
						$("#imageUrl1").val("");
						createWindow(1000,"auto","&nbsp;&nbsp;添加自营店铺内部分类","icon-add",false,"addOrEditWin");
				...
				},"-",
				{
					...
					handler:function(){
						...
						if(rows.length<=0){
							...
							$("#fileId1").val("");
							createWindow(1000,"auto","&nbsp;&nbsp;修改自营店铺内部分类","icon-edit",false,"addOrEditWin");
							$.ajax({
				...
				},"-",
				{
					...
					handler:function(){//回调函数  
						location.href="${pageContext.request.contextPath}/back/selfSupportShopProCategory/gotoSelfSupportShopInfo.action";
					}
				},"-",{text:"刷新",
					iconCls:"icon-reload",
					handler:function(){
	...
	function showDetailInfo(id){
		createWindow(700,"auto","&nbsp;&nbsp;自营店铺内部分类详情","icon-tip",false,"detailWin");
		$.ajax({
		  	   type: "POST",
			   url: "${pageContext.request.contextPath}/back/selfSupportShopProCategory/getObjectById.action",
