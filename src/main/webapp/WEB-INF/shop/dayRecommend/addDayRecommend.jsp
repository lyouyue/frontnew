		    ...
		    <table class="searchTab">
			   <tr>
					...
					<td class="search_toleft_td" height="10px;" width="145px;">
						<select id="typeId" name="dayRecommend.typeId" style="width:125px;line-height:20px;"  onchange="querySelt()" class="{validate:{required:false}}">
							<option value="">--请选择分类--</option>
							<s:iterator value="#application.categoryBrandMap" var="type1">
								<option value=""  >
								<s:property value="#type1.key.name"/>
								<s:iterator value="#type1.value" var="type2">
									<option value="<s:property value="#type2.specificationValueId"/>"  >
										&nbsp;&nbsp;&nbsp;&nbsp;<s:property value="#type2.name"/>
									</option>
								</s:iterator>
								</option>
							</s:iterator>
					...
					<td class="search_toright_td" style="width:80px;">套餐名称：</td>
					<td class="search_toleft_td" style="width:135px;"><input type="text" id="productNameT" style="width:110px;" /></td>
					<td class="search_toright_td" style="width:60px;">套餐编号：</td>
