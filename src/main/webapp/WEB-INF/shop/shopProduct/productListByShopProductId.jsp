  ...
  <head>
    ...
    $(function(){
		   ...
		   $("#tt").datagrid({//数据表格
				...
				columns:[[//未冻结字段
					{field:"productFullName",title:"套餐名称",width:120},
					{field:"logoImg",title:"套餐图片",width:100, formatter:function(value,rowData,rowIndex){  //function里面的三个参数代表当前字段值，当前行数据对象，行号（行号从0开始）
		                return "<img src='"+"<s:property value='%{#application.fileUrlConfig.uploadFileVisitRoot}'/>"+value+"' onerror='this.src=\"${fileUrlConfig.sysFileVisitRoot_back}productInfo/images/mrbj.png\"' width='30px' height='30px' />";  
		         	  }  
					},
