  ...
  <head>
    ...
    $(function(){
		   $("#tt").datagrid({//数据表格
				...
				url:"${pageContext.request.contextPath}/back/homeKeyBook/listHomeKeyBook.action",
				...
				{//工具条
					...
					iconCls:"icon-add",
					handler:function(){
						createWindow(700,'auto',"&nbsp;&nbsp;添加首页数据字典","icon-add",false,"addOrEditWin");
				...
				{text:"修改", 
					...
					handler:function(){
						...
						if(rows.length==0){//没有选择修改项
							...
							createWindow(700,'auto',"&nbsp;&nbsp;修改首页数据字典","icon-edit",false,"addOrEditWin");
							$.ajax({
	...
	function query(){
		queryParams={pageSize:pageSize,currentPage:currentPage,name:$("#name1").val(),typeName:$("#qtypeName").val()};
	...
	<div class="main">
		<table class="searchTab">
			<tr>
				<td class="search_toright_td"  style=" width:60px;"><span class="querybtn" style="font-size: 12px;">名称：</span>
				</td>
				<td class="search_toleft_td" style="width: 155px;">
					<input type="text"  id="name1" class="searchTabinput"/>
				</td>
				<td class="search_toright_td" style="width: 50px;">类型：</td>
				<td class="search_toleft_td" style="width: 165px;">
				<input type="text"  id="qtypeName" class="searchTabinput"/>
				</td>
