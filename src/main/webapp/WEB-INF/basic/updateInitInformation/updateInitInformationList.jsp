...
// 			         	msgShow("系统提示", "<p class='tipInfo'>导出成功！</p>", "warning");
  ...
  <body>
	  ...
	  <span class="querybtn"><a href="javascript:outExcel();"  style="width: 300px;color:red;">导出【套餐分类及品牌关系】数据</a></span>
	  <br/><br/><br/>
	  <span class="querybtn"><a href="javascript:leadingExcel();" style="width: 300px;color:red;">导入【套餐分类及品牌关系】数据</a></span>
	  <br/><br/><br/>
