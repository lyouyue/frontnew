...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    <title>手机首页分类数据信息</title>
    <jsp:include page="../../../util/import.jsp"/>
    <link  rel="stylesheet" type="text/css" href="${fileUrlConfig.sysFileVisitRoot_back}basic/css/tree.css"/>
    <script type="text/javascript" src="${fileUrlConfig.sysFileVisitRoot_back}/phone/js/jquery.simple.phoneHomeCategory.tree.listLink.js"></script>
    <script type="text/javascript">
		...
		function showTable(id,level){
			 ...
			 */
			 var url="${pageContext.request.contextPath}/back/phoneHomeCategoryInfo/gotoPhoneHomeCategoryInfoPage.action";
			 /* if(level==1){
						...
						<li class="root" id='1' style="margin:  0 0 0 -13px;">
							<ul>
								<li id='2'>
									<span> &nbsp;&nbsp;全部分类</span> 
									<ul class="ajax">
										<li id='3'>{url:${pageContext.request.contextPath}/back/phoneHomeCategory/getNodes.action?parentId=0}</li>
									</ul>
								</li>
							</ul>
						</li>
