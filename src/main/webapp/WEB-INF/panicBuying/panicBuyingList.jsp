				...
				%>
                    {
                        ...
                        handler:function(){
                            ...
                            if(rows==null){//没有选择修改项
                                msgShow("系统提示", "<p class='tipInfo'>请选择想要显示的套餐！</p>", "warning");
                            }else{
                                if(rows.isShow==0){
                                    ...
                                    msgShow("系统提示", "<p class='tipInfo'>该套餐正在推荐栏显示中！</p>", "warning");
                                }
                            }
                        }
                    },"-",
					...
					%>
                    {
                        ...
                        handler:function(){
                            ...
                            createWindow(1250,"auto","&nbsp;&nbsp;套餐抢购记录","icon-tip",false,"panicRecord");
                            $("#ttc").datagrid({//数据表格
                                width:"auto",
                                height:"auto",
                                fitColumns: true,//宽度自适应
