  ...
  <head>
    ...
    $(function(){
		   $("#tt").datagrid({//数据表格
				...
				columns:[[//未冻结字段
					{field:"productFullName",title:"套餐名称",width:100},
				...
				{//工具条
					...
					iconCls:"icon-add",
					handler:function(){
						createWindow(800,500,"&nbsp;&nbsp;添加套餐","icon-add",false,"addOrEditWin");
						$("#form1").css("display","");
	    		...
	    		$.ajax({
	    			...
	    			success:function(data){
	    				if(data.isSuccess=="true"){
	    		    			...
	    		    			$.ajax({
	    							   ...
	    							   success: function(data){
	    								   if(data.isSuccess=="false"){
	    									   msgShow("系统提示", "<p class='tipInfo'>其他促销活动中已经有此套餐，暂不能通过！</p>", "warning");
	    								   }
	    					...
	    					msgShow("系统提示", "<p class='tipInfo'>该活动已开启或已关闭，不能对套餐进行操作！</p>", "warning");
	    				}
	    			}
	    		});
	    	}
