...
<!--     	<input id="udiscountImage" type="hidden" name="discountCoupon.discountImage"/> -->
	    <table align="center" class="addOrEditTable" width="750px;">
		    ...
		    <tr>
		      <td class="toright_td" width="150px"><span style="color:red">* </span>优惠券类型:</td>
		      <td class="toleft_td" colspan="3">&nbsp;&nbsp;
		      	<select style="width:150px" id="activityId" name ="discountCoupon.activityId" class="{validate:{required:true}}">
