  ...
  <head>
    ...
    $(function(){
		   $("#tt").datagrid({//数据表格
				...
				url:"${pageContext.request.contextPath}/back/keybook/listKeyBook.action",
				...
				%> 
				   {//工具条
					...
					iconCls:"icon-add",
					handler:function(){
						createWindow(700,'auto',"&nbsp;&nbsp;添加数据字典","icon-add",false,"addOrEditWin");
				...
				%>
				{
					...
					handler:function(){
						...
						if(rows.length<=0){
							...
							createWindow(700,'auto',"&nbsp;&nbsp;修改数据字典","icon-edit",false,"addOrEditWin");
							$.ajax({
				...
				%>
				{
					...
					handler:function(){
						...
						$.getJSON(url);
						var url1=splitUrl[1]+"back/phoneKeyBook/updateInServletContextKeyBook.action?callback=?";
						$.getJSON(url1);
					}
				}
				,"-", 
	  ...
	  <div  class="main">
		   <table  class="searchTab">
		      <tr>
		          ...
		          <td class="search_toleft_td" style="width: 160px;"><input type="text" id="qname" name="s_name" class="searchTabinput"/></td>
		          <td class="search_toright_td" style="width: 70px;">类型名称：</td>
		          <td class="search_toleft_td" style="width: 170px;"><input type="text" id="qtypeName" name="s_companyName" class="searchTabinput"/></td>
		          <td class="search_toleft_td">
		             	<a id="btnCancel" class="easyui-linkbutton" icon="icon-search" href="javascript:query()">查询</a>
		           		<a id="btnCancel_reset" class="easyui-linkbutton"  iconCls="icon-undo" href="javascript:reset()">重置</a>
		          </td>
		       </tr>
		   </table>
