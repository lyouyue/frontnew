		     ...
		     $("#shippingAddress").val(s1+s2+s3+address);
               var options = {  
					 ...
					 $("#returnsApplyId").val(null);
               		  ...
               		  if(productId == -1){
						  msgShow("系统提示", "<p class='tipInfo'>没有商品不能退货！</p>", "warning");  
               			  return false;
               		  }else{
  		...
  		$.ajax({
  			...
  			success:function(data){
  				...
  				if(ordersLisList.length>0){
		        	 ...
		        	 $("#ordersListListHtml").html("<font color=\"red\">该订单没有商品信息!</font>");
		         }
  			}
  		});
  	}
...
<%--        <input id="updateMember" type="hidden" name="updateMember"  value="">--%>
	    <table align="center" class="addOrEditTable">
		    ...
		    <tr>
  			...
  			<tr>
				<td class="toright_td" width="150px">商品信息:</td>
		    ...
		    <tr>
		      <td class="toright_td" width="150px">商品外观:</td>
		      <td class="toleft_td">
		    ...
		    <tr>
		      <td class="toright_td" width="150px">商品包装:</td>
		      <td class="toleft_td">
		    ...
		    <tr>
		      <td class="toright_td" width="150px">商品附件:</td>
		    ...
		    <tr>
			  ...
			  <td class="toleft_td">
			  	...
			  	&nbsp;&nbsp;<input id="returnsMode_1" type="radio" name="returnsApply.returnsMode" value="1"/>会员邮寄商品至售后<br/>
