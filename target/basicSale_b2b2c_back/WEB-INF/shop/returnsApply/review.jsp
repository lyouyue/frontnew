 ...
 <form id="form2" method="post">
   ...
   <input id="operatorTime" type="hidden" name="returnsApplyOPLog.operatorTime"  value="">
    <table align="center" class="addOrEditTable">
	    ...
	    <tr><td class="toright_td" width="200px">商品名称:</td><td class="toleft_td"><span id="rproductName"></span></td></tr>
    	...
    	<tr>
		 ...
		 <tr>
		      <td class="toright_td" width="200px">商品外观:</td>
		      <td class="toleft_td">
		  ...
		  <tr>
		      <td class="toright_td" width="200px">商品包装:</td>
		      <td class="toleft_td">
		    ...
		    <tr><td class="toright_td" width="200px">商品附件:</td><td class="toleft_td"><span id="rproductAccessories"></span></td></tr>
