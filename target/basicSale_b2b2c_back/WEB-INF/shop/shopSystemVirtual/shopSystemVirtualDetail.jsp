	...
	function showDetailInfo(id){
		...
		$.ajax({
			   ...
			   success: function(data){
				   ...
				   htmlString+=' <tr><td width="200px" class="toright_td" rowspan="'+l1+'">购买商品:</td><td width=200px" class="toleft_td">商品</td><td width="200px" class="toleft_td">赠送金币数量</td><td width="200px" class="toleft_td" colspan="2">赠送总数</td></tr>';
