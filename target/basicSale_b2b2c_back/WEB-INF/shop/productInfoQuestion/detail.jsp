...
<script type="text/javascript">
	function showDetailInfo(id){
		createWindow(800,440,"&nbsp;&nbsp;商品答疑详情","icon-tip",false,"detailWin");
...
<div id="detailWin">
	<table align="center" class="addOrEditTable" width="800px;" >
		...
		<tr>
			<td class="toright_td" width="150px">商品名称:</td><td  class="toleft_td" colspan="3">&nbsp;&nbsp;<span id="dproductName"></span></td>
		</tr>
		<tr>
		...
		<tr>
			<td class="toright_td" >店铺回复:</td><td class="toleft_td" colspan="3">&nbsp;&nbsp;<span id="danswer"></span></td>
		</tr>
		<tr>
