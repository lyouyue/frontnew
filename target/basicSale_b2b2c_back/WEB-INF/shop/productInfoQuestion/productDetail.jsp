...
<script type="text/javascript">
	function showProductDetail(id){
		createWindow(1000,500,"&nbsp;&nbsp;商品详情","icon-tip",false,"detailWin");
			   ...
			   success: function(data){
				   ...
				   if(jaattrList!=""){
					   ...
					   if(prodAttr1.length>0){
						   var htmlAttrStr1="<tr><td colspan='2'>商品的属性</td></tr>";
	  			  ...
	  			  if(productInfo.productParametersValue!=""){
					   var prodPara1 = eval(productInfo.productParametersValue);
		  			   if(prodPara1.length){
			  			   var htmlParaStr1="<tr><td colspan='2'>商品的参数</td></tr>";
...
<div id="productDetailWin">
    <table align="center" class="addOrEditTable" width="800px;" >
    	...
    	<tr>
	    	<td class="toright_td" >商品所属分类:</td><td class="toleft_td" colspan="3">&nbsp;&nbsp;<span id="d_productTypeName"></span></td>
	    </tr>
    	<tr>
	      <td class="toright_td">商品品牌:</td>
	      <td class="toleft_td">&nbsp;&nbsp;
	    ...
	    <tr>
	    	<td class="toright_td">商品名称:</td><td class="toleft_td">&nbsp;&nbsp;<span id="d_productName"></span></td>
	    ...
	    <tr>
		    <td class="toright_td" width="200px">商品图片:</td><td  class="toleft_td" colspan="3">&nbsp;&nbsp;<span id="d_smallPhoto"></span></td>
	    </tr>
	    <tr>
    	...
    	<tr>
	    	<td class="toright_td" width="200px">是否为新商品:</td><td  class="toleft_td">&nbsp;&nbsp;<span id="d_isNew"></span></td>
    	</tr>
    </table>
