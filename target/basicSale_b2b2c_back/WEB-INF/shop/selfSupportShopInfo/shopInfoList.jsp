				...
				toolbar:[
					...
					%>
					{
						...
						handler:function(){
							var rows = $("#tt").datagrid("getSelections");//找到所有选中的行
							if(rows.length<=0){
								msgShow("系统提示", "<p class='tipInfo'>请选择自营店铺！</p>", "warning");
							}else if(rows.length>1){
								...
								createWindow(1020,480,"&nbsp;&nbsp;修改自营店铺信息","icon-edit",false,"addOrEditWin",10);
...
<body>
	  <jsp:include page="../../util/item.jsp"/>
		...
		<tr>
			<td class="search_toright_td" style="width:75px;">店铺账号：</td>
