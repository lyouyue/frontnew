...
<html xmlns="http://www.w3.org/1999/xhtml" >
  <head>
    ...
    $(function(){
	   ...
	   $("#tt").datagrid({//数据表格
			/* title:"商品分类列表信息:<font style='color:blue;'>商品分类&nbsp;&gt;&nbsp;${prodTypeNames}</font>",
			iconCls:"icon-save",  */
			width:"auto",
			height:"auto",
		...
		,"-",{
			...
			handler:function(){
				...
				if(rows.length==0){//没有选择修改项
					...
					var type_level = <s:property value="type_level"/>;//商城控制商品分类级别
					var level = ${level}+2;
	...
	function showDetailInfo(id){
		$.ajax({
			   ...
			   dataType: "JSON",
			   success: function(data){
					createWindow(800,'auto',"&nbsp;&nbsp;商品分类详情","icon-add",false,"detailWin");
