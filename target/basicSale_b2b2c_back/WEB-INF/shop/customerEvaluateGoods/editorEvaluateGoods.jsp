...
<div id="addOrEditWin">
    ...
    <table align="center" class="addOrEditTable">
    	...
    	<tr><td class="toright_td" width="150px">商品名称:</td><td class="toleft_td">&nbsp;&nbsp;<span id="eproductFullName"></span></td><td class="toright_td" width="150px">商品价格:</td><td class="toleft_td">&nbsp;&nbsp;￥<span id="esalesPrice"></span></td></tr>
