...
$(function(){
 ...
 <div id="addOrEditWin">
		    <form id="form1"  method="post" action="${pageContext.request.contextPath}/back/messageCenter/saveOrUpdateMessageCenter.action">
			    <table align="center" class="addOrEditTable" width="700px;">
			    	<tr>
				      <td class="toright_td" width="140px">收件人:&nbsp;&nbsp;</td>
				    ...
				    <tr>
				      ...
				      <td  class="toleft_td"  width="400px">&nbsp;&nbsp;
					      ...
					      <input   type="radio" name="messageCenter.messageSendState" value="2" />保存至草稿箱
				      </td>
				    </tr>
			    </table>
