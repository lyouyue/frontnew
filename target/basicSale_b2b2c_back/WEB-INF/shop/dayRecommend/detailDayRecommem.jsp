...
function showDetailInfo(id){
	...
	createWindow(700,'auto',"&nbsp;&nbsp;每日推荐商品详情","icon-tip",false,"detailWin");
	$.ajax({
			type: "POST",
...
<div id="detailWin">
    <table align="center" class="addOrEditTable" width="400px">
	    <tr>
	      <td class="toright_td" width="150px">商品图片:</td><td class="toleft_td">&nbsp;&nbsp;<span id="d_logoImg"></span></td>
	    </tr>
	    <tr>
	      <td class="toright_td" width="150px">商品名称:</td><td class="toleft_td">&nbsp;&nbsp;<span id="d_productName"></span></td>
	    </tr>
	    <tr>
	      <td class="toright_td" width="150px">商品编号:</td><td class="toleft_td">&nbsp;&nbsp;<span id="d_productCode"></span></td>
	    </tr>
	    <tr>
