...
<script type="text/javascript" src="${pageContext.request.contextPath}/DatePicker/WdatePicker.js"></script>
		...
		$.ajax({
			...
			success: function(data){
				...
				if(egList!=null&&egList!=""){
					  ...
					  html += "<tr><td align='center' width='150px'>商品名称<\/td><td align='center' width='150px'>评价内容<\/td><\/tr>";
	...
	<div id="detailWin" style="width:100%;">
		<table align="center" class="addOrEditTable" width="100%;" >
			...
			<tr>
				<td class="toright_td" >商品总金额:&nbsp;&nbsp;</td><td>&nbsp;&nbsp;<span id="d_productSumNumber"></span>&nbsp;元</td>
			...
			<tr class="titlebg"><td colspan='8' align='center' style="font-weight: bolder;">店铺信息</td></tr>
			<tr>
				<td class="toright_td" >店铺名称:&nbsp;&nbsp;</td><td>&nbsp;&nbsp;<span id="d_shopName"></span></td>
				<td class="toright_td" >店铺邮编:&nbsp;&nbsp;</td><td>&nbsp;&nbsp;<span id="d_postCode"></span></td>
				<td class="toright_td" >店铺地址:&nbsp;&nbsp;</td><td colspan='3'>&nbsp;&nbsp;<span id="d_shopAddress"></span></td>
			</tr>
