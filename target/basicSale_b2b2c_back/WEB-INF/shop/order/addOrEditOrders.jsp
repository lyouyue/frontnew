	   ...
	   <form id="form1"  method="post">
	  	...
	  	<table align="center" class="addOrEditTable" width="850px;" >
			...
			<tr>
	   		...
	   		<tr>
		   		<td class="toright_td" width="100px">商品总金额:&nbsp;&nbsp;</td><td>&nbsp;&nbsp;<input id="productSumNumber" type="text" name="orders.productSumNumber" value=""  class="{validate:{required:true,maxlength:[10]}}"/></td>
	  		...
	  		<tr>
	   		...
	   		<tr>
	   			...
	   			<td colspan="3">&nbsp;&nbsp;
		  		   	<input  type="radio" id="oosOperator_1" name="orders.oosOperator" value="1" checked="checked"/>等待所有商品备齐再发货
