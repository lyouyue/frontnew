    	...
    	function showDetailInfo(id){
			...
			$.ajax({
			   ...
			   success: function(data){
				  ...
				  htm+="<tr><td width='85px' align='center'>商品图片<\/td><td width='120px' align='center'>商品名称<\/td><td width='50px' align='center'>商品编号<\/td><td width='50px' align='center'>市场价<\/td><td width='50px' align='center'>销售价<\/td><td width='50px' align='center'>购买数量<\/td><td width='50px' align='center'>条形码<\/td><td width='60px' align='center'>返利比例(一级)<\/td><td width='60px' align='center'>返利比例(二级)<\/td><td width='60px' align='center'>返利比例(三级)<\/td><td width='60px' align='center'>返利金额(一级)<\/td><td width='60px' align='center'>返利金额(二级)<\/td><td width='60px' align='center'>返利金额(三级)<\/td><\/tr>";
