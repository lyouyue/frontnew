						...
						if(rows.length==0){//没有选择修改项
							...
							$.ajax({
							   ...
							   success: function(data){
								  ...
								  html += "<tr><td align='center' width='150px'>商品图片<\/td><td align='center' width='150px'>商品名称<\/td><td align='center' width='150px'>销售价<\/td><td align='center' width='150px'>运费<\/td>"+
							...
							createWindow(800,'auto',"&nbsp;&nbsp;查看订单商品","icon-search",false,"view_Order_Products");
