...
<div id="detailWin">
    ...
    <table align="center" class="addOrEditTable">
	    ...
	    <tr>
	    	<td class="toright_td">商品名称:</td><td class="toleft_td">&nbsp;&nbsp;<span id="dproductName"></span></td>
	    ...
	    <tr>
		    <td class="toright_td" width="200px">商品小图片:</td><td  class="toleft_td">&nbsp;&nbsp;<span id="dsmallPhoto"></span></td>
		    <td class="toright_td" width="200px">商品大图片:</td><td  class="toleft_td">&nbsp;&nbsp;<span id="dbigPhoto"></span></td>
	    </tr>
	    <tr>
	    ...
	    <tr>
		    ...
		    <td class="toright_td" width="200px">商品编号:</td><td  class="toleft_td">&nbsp;&nbsp;<span id="dproductCode"></span></td>
	    </tr>
	    <tr>
