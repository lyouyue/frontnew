...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
	...
	$(function(){
			$("#tt").datagrid({//数据表格
				/* title:"商品扩展属性列表信息:<font color='blue'>${name}</font>",
				iconCls:"icon-save",  */
				width:"auto",
				height:"auto",
				...
				{//工具条
					...
					iconCls:"icon-add",
					handler:function(){
						createWindow(900,430,"&nbsp;&nbsp;添加商品属性","icon-add",false,"addOrEditWin",10);
						$("#nameMsg").html("");
						$("#save").css("display","");
				...
				%>
				{
					...
					handler:function(){
						...
						if(rows.length<=0){
							...
							createWindow(900,430,"&nbsp;&nbsp;修改商品属性","icon-edit",false,"addOrEditWin",10);
