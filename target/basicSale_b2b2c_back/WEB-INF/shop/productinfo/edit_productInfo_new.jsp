...
<script type="text/javascript">
			...
			$("#basicForm").validate({
				...
				submitHandler: function(form) {
					...
					/* else if($("#e_barCode").val()==""){
						...
						msgShow("系统提示", "<p class='tipInfo'>基本信息，商品重量必填!</p>", "warning");
						isRepeats = false;
		...
		function deleteProductImageUpdate(value,productImageId){
			if(productImageId!=0&&productImageId!=null){
				$.messager.confirm("系统提示", "<p class='tipInfo'>商品图片删除后将无法恢复！</p>",function(data){
					if(data){
							$.ajax({
								type: "POST",
								dataType: "JSON",
		...
		<div class="product_content">
			...
			<div id="product_rightBox" >
				<div class="easyui-tabs" id="editTab">
					...
					<div title="基本信息" class="addProductByPT setWidth">
						...
						<form id="basicForm"  action="" method="post" enctype="multipart/form-data">
							...
							<table style="margin:11px;">
								...
								<tr>
									<th style="text-align: right;width:200px;"><i class="product_colorRed">*</i>&nbsp;商品分类：</th>
									<td colspan="3">
								...
								<tr>
									...
									<th class="toright_td"><i class="ColorRed">*</i>&nbsp;商品品牌：</th><td id="e_brandTd"></td>
									<th class="toright_td"><i class="ColorRed">*</i>&nbsp;计量单位：</th><td id="e_measuringUnit"></td>
								</tr>
								<tr>
									<th class="toright_td"><i class="ColorRed">*</i>&nbsp;商品编号：</th><td><input   type="text" id="e_productCode" name="productInfo.productCode" class="{validate:{required:true,maxlength:[30]}} us_input"  /></td>
								...
								<tr>
									...
									<th class="toright_td"><i class="ColorRed">*</i>&nbsp;商品库存：</th><td><input type="text" id="e_storeNumber" name="productInfo.storeNumber" class="{validate:{required:true,number:true,maxlength:[8]}} us_input"/></td>
								</tr>
								<tr>
									...
									<th class="toright_td">&nbsp;商品重量：</th><td><input id="e_weight" type="text" name="productInfo.weight" class="{validate:{number:true,maxlength:[10]}} us_input"  />&nbsp;&nbsp;&nbsp;kg<span id="e_measuringUnitName1"></span></td>
								...
								<tr>
									...
									<th class="toright_td">商品备提示：</th><td><input id="e_note" type="text" name="productInfo.note" class="{validate:{maxlength:[1000]}} us_input"/></td>
								</tr>
								<tr>
					...
					<!-- 商品规格 begin-->
					<div title="商品规格" class="addProductByPT" style="height:auto;min-height:410px;">
