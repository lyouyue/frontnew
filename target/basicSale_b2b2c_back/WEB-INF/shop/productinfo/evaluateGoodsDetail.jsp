...
<div id="detailWin">
	<table align="center" class="addOrEditTable">
		<tr><td class="toright_td" width="150px">商品图片:</td><td class="toleft_td" colspan="3">&nbsp;&nbsp;<span id="dLogoImg"></span></td></tr>
		...
		<tr><td class="toright_td" width="150px">商品名称:</td><td class="toleft_td">&nbsp;&nbsp;<span id="dproductFullName"></span></td>
