...
<head>
	...
	$(function(){
		$("#tt").datagrid({//数据表格
			/* title:"商品详细参数列表信息:<font color='blue'>${name}</font>",
			iconCls:"icon-save",  */
			width:"auto",
			height:"auto",
			...
			{//工具条
				...
				iconCls:"icon-add",
				handler:function(){
					createWindow(900,450,"&nbsp;&nbsp;添加商品参数","icon-add",false,"addOrEditWin");
			...
			{//工具条
				...
				handler:function(){
					...
					if(rows.length==0){//没有选择修改项
						...
						createWindow(900,450,"&nbsp;&nbsp;修改商品参数","icon-edit",false,"addOrEditWin");
						$("#detailWin").css("display","none");
						$("#addOrEditWin").css("display","");
						$("#btnSave").attr("onclick","$('#form1').submit();");//设置保存可用
						$.ajax({
