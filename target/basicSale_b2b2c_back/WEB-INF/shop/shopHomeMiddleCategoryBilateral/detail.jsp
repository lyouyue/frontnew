    ...
    <table align="center" style="width: 700px;" class="addOrEditTable">
        <tr>
    	 ...
    	 <tr>
	    	...
	    	<td class="toleft_td" colspan="3">&nbsp;&nbsp;<span id="dtitle"></span></td>
		</tr>
	    <tr><td class="toright_td" >描述:&nbsp;&nbsp;</td>
	    	<td class="toleft_td" colspan="3">&nbsp;&nbsp;<span id="dsynopsis"></span></td>
    	</tr>
	    <tr>
	      <td class="toright_td" >链接:&nbsp;&nbsp;</td>
	      <td class="toleft_td">&nbsp;&nbsp;<span id="dlink"></span></td>
	      <td class="toright_td" >类型:&nbsp;&nbsp;</td>
	      <td class="toleft_td">&nbsp;&nbsp;<span id="dtype"></span></td>
		</tr>
	    <tr>
