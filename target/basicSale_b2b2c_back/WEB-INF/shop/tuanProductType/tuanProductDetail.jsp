...
<div id="detailWin">
	<table id="detailTable" align="center" class="addOrEditTable" width="800px;" style="margin-left:43px;">
		...
		<tr>
			<td align="right" width="150px">商品所属分类:</td>
		...
		<tr>
			<td align="right" width="150px">商品品牌:</td>
